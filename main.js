...
let forRendQuestionsArray = [
    ...
    [
        new Questions('9. Ка Хейли?', 'a) «Аэропорт»', 'b) «Отель»', 'c) «Больница»', 'd) «Колеса»' ,'Вопрос на 15000$ за правильный ответ', 15000, 'c) «Больница»', 5000),
    ...
    [
        new Questions('13. Уі Марч?', 'a) Маленькі жінки', 'b) Вбити пересмішника', 'c) Том Сойєр', 'd) Мобі Дік', 'Вопрос на 250000$ за правильный ответ', 250000, 'a) Маленькі жінки', 25000),
